...
void swap(struct node* ref1, struct node* ref2) {
     ...
     */
    /* Your code here */
	struct node* ref1p = ref1->prev;
    struct node* ref2p = ref2->prev;

    struct node* ref2n_o = ref2->next;
    struct node* ref1n_o = ref1->next;

    struct node* ref1n = ref1->next;
    struct node* ref2n = ref2->next;

    struct node* ref2p_o = ref2->prev;
    struct node* ref1p_o = ref1->prev;
